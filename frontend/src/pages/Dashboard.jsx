...
const Dashboard = () => {
    ...
    const [activeTab, setActiveTab] = useState('overview'); // 'overview' | 'transactions' | 'refunds' | 'payments' | 'webhooks'
            ...
            <div className="w-72 bg-slate-900 text-white flex flex-col fixed h-full shadow-2xl z-30">
                <div className="p-8">
                    <div className="flex items-center space-x-3 mb-6">
                        ...
                        <h1 className="text-xl font-bold tracking-tight">Payment Gateway</h1>
                    </div>
                </div>
